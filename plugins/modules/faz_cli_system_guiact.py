...
def main():
    ...
    module_arg_spec = {
        ...
        'cli_system_guiact': {
            ...
            'v_range': [['6.2.1', '7.4.0']],
            'options': {
                'backup_all': {'v_range': [['6.2.1', '7.4.0']], 'type': 'str'},
                'backup_conf': {'v_range': [['6.2.1', '7.4.0']], 'type': 'str'},
                'eventlog_msg': {'v_range': [['6.2.1', '7.4.0']], 'type': 'str'},
                'eventlog_path': {'v_range': [['6.2.1', '7.4.0']], 'type': 'str'},
                'reboot': {'v_range': [['6.2.1', '7.4.0']], 'type': 'int'},
                'reset2default': {'v_range': [['6.2.1', '7.4.0']], 'type': 'int'},
                'restore_all': {'v_range': [['6.2.1', '7.4.0']], 'type': 'str'},
                'restore_conf': {'v_range': [['6.2.1', '7.4.0']], 'type': 'str'},
                'time': {'v_range': [['6.2.1', '7.4.0']], 'type': 'str'}
            }
