...
def main():
    ...
    module_arg_spec = {
        ...
        'cli_system_snmp_sysinfo': {
            ...
            'options': {
                ...
                'engine-id': {'type': 'str'},
                'fortianalyzer-legacy-sysoid': {'choices': ['disable', 'enable'], 'type': 'str'},
                'location': {'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'cli_system_snmp_sysinfo'),
