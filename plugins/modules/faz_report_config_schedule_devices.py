...
DOCUMENTATION = '''
---
module: faz_report_config_schedule_devices
short_description: Config devices.
description:
...
options:
    ...
    adom:
        ...
        required: true
    schedule_name:
        description: The parameter (schedule_name) in requested url.
        type: str
        required: true
...
def main():
    ...
    url_params = ['adom', 'schedule_name']
    module_primary_key = 'devices_name'
    module_arg_spec = {
        ...
        'schedule_name': {'required': True, 'type': 'str'},
        'report_config_schedule_devices': {
            'type': 'dict',
            'v_range': [['6.2.1', '']],
            'options': {
    ...
    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'report_config_schedule_devices'),
