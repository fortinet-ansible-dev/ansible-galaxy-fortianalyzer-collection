    ...
    module_arg_spec = {
        ...
        'cli_fmupdate_service': {
            ...
            'options': {
                ...
                'query-geoip': {'v_range': [['6.2.1', '6.4.1']], 'choices': ['disable', 'enable'], 'type': 'str'}
            }

        }
    }

    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'cli_fmupdate_service'),
