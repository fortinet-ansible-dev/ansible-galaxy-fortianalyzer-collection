...
DOCUMENTATION = '''
---
module: faz_report_config_layout_footer
short_description: Config footer.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'report_config_layout_footer'),
