...
DOCUMENTATION = '''
---
module: faz_report_config_chart_variabletemplate
short_description: Config variable-template.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'report_config_chart_variabletemplate'),
