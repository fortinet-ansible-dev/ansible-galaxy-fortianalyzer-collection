...
def main():
    ...
    module_arg_spec = {
        ...
        'cli_system_snmp_community_hosts6': {
            'type': 'dict',
            'v_range': [['6.2.1', '']],
            'options': {'id': {'type': 'int'}, 'interface': {'type': 'str'}, 'ip': {'type': 'str'}}

        }
    }

    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'cli_system_snmp_community_hosts6'),
