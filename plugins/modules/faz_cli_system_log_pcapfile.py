...
def main():
    ...
    module_arg_spec = {
        ...
        'cli_system_log_pcapfile': {
            'type': 'dict',
            'v_range': [['7.4.1', '']],
            'options': {'download-mode': {'v_range': [['7.4.1', '']], 'choices': ['plain', 'zip', 'zip-with-password'], 'type': 'str'}}
        }
    }

    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'cli_system_log_pcapfile'),
