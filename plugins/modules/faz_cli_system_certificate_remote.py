...
def main():
    ...
    module_arg_spec = {
        ...
        'cli_system_certificate_remote': {
            'type': 'dict',
            'v_range': [['6.2.1', '']],
            'options': {'cert': {'type': 'str'}, 'comment': {'type': 'str'}, 'name': {'type': 'str'}}
        }
    }

    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'cli_system_certificate_remote'),
