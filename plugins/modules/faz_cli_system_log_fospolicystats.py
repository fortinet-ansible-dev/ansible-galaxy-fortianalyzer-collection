...
DOCUMENTATION = '''
---
module: faz_cli_system_log_fospolicystats
...
- hosts: fortianalyzer_inventory
  ...
  tasks:
    - name: FortiOS policy statistics settings.
      faz_cli_system_log_fospolicystats:
...
def main():
    ...
    module = AnsibleModule(argument_spec=remove_revision(check_parameter_bypass(module_arg_spec, 'cli_system_log_fospolicystats')),
