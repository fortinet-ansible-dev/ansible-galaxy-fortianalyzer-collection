...
DOCUMENTATION = '''
---
module: faz_report_config_layoutfolder
short_description: Config layout-folder.
description:
...
def main():
    ...
    module_arg_spec = {
        ...
        'report_config_layoutfolder': {
            ...
            'options': {
                'folder-id': {'type': 'int'},
                'parent-id': {'type': 'int'},
                'folder-name': {'v_range': [['6.2.2', '6.2.12'], ['7.0.0', '7.0.0']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'report_config_layoutfolder'),
