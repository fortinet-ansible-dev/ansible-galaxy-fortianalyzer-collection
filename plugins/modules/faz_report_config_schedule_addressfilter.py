...
DOCUMENTATION = '''
---
module: faz_report_config_schedule_addressfilter
short_description: Config address-filter.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'report_config_schedule_addressfilter'),
