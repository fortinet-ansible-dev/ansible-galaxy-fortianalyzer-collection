...
DOCUMENTATION = '''
---
module: faz_report_config_layout_header
short_description: Config header.
description:
  ...
  tasks:
    - name: Config header.
      fortinet.fortianalyzer.faz_report_config_layout_header:
        ...
        report_config_layout_header:
          header_id: 0 # Required variable, integer
...
def main():
    ...
    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'report_config_layout_header'),
