...
DOCUMENTATION = '''
---
module: faz_report_config_dataset_variable
...
options:
    ...
    adom:
        ...
        required: true
    dataset_name:
        description: The parameter (dataset_name) in requested url.
        type: str
        required: true
...
def main():
    ...
    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'report_config_dataset_variable'),
