...
def main():
    ...
    module_arg_spec = {
        ...
        'cli_system_log_maildomain': {
            'type': 'dict',
            'v_range': [['6.2.1', '']],
            'options': {'devices': {'type': 'str'}, 'domain': {'type': 'str'}, 'id': {'type': 'int'}, 'vdom': {'type': 'str'}}

        }
    }

    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'cli_system_log_maildomain'),
