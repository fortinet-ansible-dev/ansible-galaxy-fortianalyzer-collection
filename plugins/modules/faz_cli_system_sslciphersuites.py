...
DOCUMENTATION = '''
---
module: faz_cli_system_sslciphersuites
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'cli_system_sslciphersuites'),
