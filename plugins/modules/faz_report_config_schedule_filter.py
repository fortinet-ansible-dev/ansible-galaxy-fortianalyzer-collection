...
DOCUMENTATION = '''
---
module: faz_report_config_schedule_filter
short_description: Config filter.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'report_config_schedule_filter'),
