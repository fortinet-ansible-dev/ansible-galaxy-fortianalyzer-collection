...
def main():
    ...
    module_arg_spec = {
        ...
        'cli_system_logforwardservice': {
            'type': 'dict',
            'v_range': [['6.2.1', '']],
            'options': {'accept-aggregation': {'choices': ['disable', 'enable'], 'type': 'str'}, 'aggregation-disk-quota': {'type': 'int'}}
        }
    }

    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'cli_system_logforwardservice'),
