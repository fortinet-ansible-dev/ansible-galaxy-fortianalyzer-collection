...
def main():
    ...
    module_arg_spec = {
        ...
        'cli_system_route': {
            'type': 'dict',
            'v_range': [['6.2.1', '']],
            'options': {'device': {'type': 'str'}, 'dst': {'type': 'str'}, 'gateway': {'type': 'str'}, 'seq_num': {'type': 'int'}}

        }
    }

    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'cli_system_route'),
