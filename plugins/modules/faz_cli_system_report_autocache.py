    ...
    module_arg_spec = {
        ...
        'cli_system_report_autocache': {
            ...
            'options': {
                ...
                'sche-rpt-only': {'v_range': [['7.0.8', '7.0.11'], ['7.2.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'}
            }

        }
    }

    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'cli_system_report_autocache'),
