...
def main():
    ...
    module_arg_spec = {
        ...
        'cli_system_logfetch_serversettings': {
            'type': 'dict',
            'v_range': [['6.2.1', '']],
            'options': {'max-conn-per-session': {'type': 'int'}, 'max-sessions': {'type': 'int'}, 'session-timeout': {'type': 'int'}}

        }
    }

    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'cli_system_logfetch_serversettings'),
