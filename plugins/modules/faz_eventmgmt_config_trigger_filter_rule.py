...
options:
    ...
    adom:
        ...
        required: true
    filter_id:
        description: The parameter (filter_id) in requested url.
        type: str
        required: true
    trigger_id:
...
def main():
    ...
    url_params = ['adom', 'filter_id', 'trigger_id']
    ...
    module_arg_spec = {
        ...
        'filter_id': {'required': True, 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=modify_argument_spec(module_arg_spec, 'eventmgmt_config_trigger_filter_rule'),
