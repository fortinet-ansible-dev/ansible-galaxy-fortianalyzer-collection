...
options:
    ...
    sys_proxy_json:
        ...
        suboptions:
            ...
            timeout:
                type: int
                description: 'Maximum time in seconds to wait for response from remote device.  If no response recieved from remote device before timeout ex...'
...
def main():
    ...
    module = AnsibleModule(argument_spec=remove_revision(check_parameter_bypass(module_arg_spec, 'sys_proxy_json')),
